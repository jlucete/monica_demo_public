...
class Parser {
    ...
    __init() {
        this.cmdLabels = `A BE SEA D E F G EIGHTCH ONE TO THREE FOUR FIVE SIX SEVEN EIGHT PAWN KNIGHT BISHOP ROOK QUEEN KING CAPTURE MOVE UNDO MY LAST START NEW GAME LOAD THE MONICA TRANSFORMER MODEL CASTLE KINGSIDE QUEENSIDE SEE WON TWO`.split(" ");
        const groundTruth = "A B C D E F G H 1 2 3 4 5 6 7 8 PAWN KNIGHT BISHOP ROOK QUEEN KING CAPTURE MOVE UNDO MY LAST START NEW GAME LOAD THE MONICA TRANSFORMER MODEL CASTLE KINGSIDE QUEENSIDE C 1 2".split(" ");
